    ...
    if (!messengers) {
      ...
      messengers.innerHTML =
        ...
        '<a class="msg-btn msg-tg" href="https://t.me/kappam6abless" target="_blank" rel="noopener noreferrer" title="Telegram" aria-label="Telegram">' +
          ...
          '</svg>' +
        '</a>' +
        /* Max — официальный стиль (пузырь-кольцо) */
        '<a class="msg-btn msg-max" href="https://max.ru/u/f9LHodD0cOK1_MzS_d0c5a3nP4p3wlhHK73nirp7wU3DQbRRzM8P8lkkhII" target="_blank" rel="noopener noreferrer" title="Max" aria-label="Max">' +
          '<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">' +
            '<defs>' +
              ...
              '</linearGradient>' +
            '</defs>' +
            '<path fill="url(#maxGrad)" d="M12 3.5c-4.7 0-8.5 3.8-8.5 8.5 0 1.7.5 3.3 1.4 4.6l-1.1 3.9 4.1-1.1c1.2.7 2.6 1.1 4.1 1.1 4.7 0 8.5-3.8 8.5-8.5S16.7 3.5 12 3.5zm0 14.2c-1.3 0-2.5-.3-3.6-.9l-.3-.2-2.4.6.6-2.3-.2-.3c-.7-1.1-1.1-2.4-1.1-3.7 0-3.7 3-6.7 6.7-6.7s6.7 3 6.7 6.7-3 6.7-6.7 6.7z"/>' +
          '</svg>' +
        '</a>';
